...
from Yukinon.modules import ALL_MODULES
from Yukinon.modules.helper_funcs.alternate import typing_action
from Yukinon.modules.helper_funcs.chat_status import is_user_admin
from Yukinon.modules.helper_funcs.misc import paginate_modules
from Yukinon.modules.helper_funcs.readable_time import get_readable_time
...
buttons = [
    [
        InlineKeyboardButton(
            text="💛Yukino News💛", url="https://t.me/waifuNetwork"
        ),
        InlineKeyboardButton(
            text="💚Support💚", url="https://t.me/tr0j3n"
        ),
    ],
    [
        InlineKeyboardButton(
            text="Source 🗒", url="https://t.me/troj3n"
        ),
        InlineKeyboardButton(
    ...
    [
        InlineKeyboardButton(
            ...
            url="t.me/Yukinonthecutebot?startgroup=true",
        ),
    ],
]
...
Support them  [TROJ3N](t.me/tr0j3n)"""
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Yukinon.modules." + module_name)
...
def Natsuki_about_callback(update, context):
    ...
    if query.data == "aboutmanu_":
        query.message.edit_text(
            ...
            f"\n\n Join [Yukino's Updates](https://t.me/waifuNetwork) To Keep Yourself Updated About {dispatcher.bot.first_name}"
        ...
        query.message.edit_text(
            ...
            f"\n\nYou Can get support {dispatcher.bot.first_name} by joining [Yukino's Support](https://t.me/tr0j3n).\n"
            f"",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
        ...
        query.message.edit_text(
            text=f"*{dispatcher.bot.first_name} and Our Other Bots.*"
            f"\n\nCheck Here [Waifu Net](https://t.me/waifuNetwork)."
            f"\n\n{dispatcher.bot.first_name}'s source code was written by TROJ3N"
