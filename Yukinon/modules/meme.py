...
import Yukinon.modules.helper_funcs.fun_strings as fun
from Yukinon import DEMONS, DRAGONS, dispatcher
...
Yukino will reply random strings accordingly when these words are used!
