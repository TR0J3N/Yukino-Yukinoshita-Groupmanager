...
from Yukinon import DEV_USERS, OWNER_ID, dispatcher
from Yukinon.__main__ import GDPR, STATS
from Yukinon.modules.disable import DisableAbleCommandHandler
from Yukinon.modules.helper_funcs.alternate import send_action, typing_action
    ...
    if not query:
        ...
        if song:
            if song.lyrics:
                ...
                reply = "Couldn't find any lyrics for that song!sorry!"
        else:
