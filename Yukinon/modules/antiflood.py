...
from Yukinon import TIGERS, WOLVES, dispatcher
...
from Yukinon.modules.helper_funcs.string_handling import extract_time
from Yukinon.modules.log_channel import loggable
from Yukinon.modules.sql import antiflood_sql as sql
...
def check_flood(update, context) -> str:
    ...
    try:
        ...
        if getmode == 1:
            ...
            tag = "TMUTE"
        send_message(
            update.effective_message, "Beep Boop! Beep Beep!\n{}!".format(execstrings)
        )
        ...
        msg.reply_text(
            "I can't restrict people here, give me permissions first! Until then, I'll disable anti-flood. Hump!"
        )
...
def flood(update, context):
    ...
    if limit == 0:
        ...
        if conn:
            ...
            text = msg.reply_text(
                "I'm currently restricting members after {} consecutive messages. HE HE!".format(
                    limit
                )
            )
...
def set_flood_mode(update, context):
    ...
    if conn:
        ...
        if update.effective_message.chat.type == "private":
            send_message(
                update.effective_message,
                "This command is meant to use in group not in PM Baka!",
            )
            return ""
