...
from Yukinon.modules.helper_funcs.extraction import extract_user_and_text
from Yukinon.modules.helper_funcs.string_handling import extract_time
from Yukinon.modules.log_channel import gloggable, loggable
...
def ban(update: Update, context: CallbackContext) -> str:
    ...
    if not user_id:
        message.reply_text("Is that a user?")
        return log_message
    ...
    if is_user_ban_protected(chat, user_id, member) and user not in DEV_USERS:
        if user_id == OWNER_ID:
            message.reply_text("Trying to put me against a God level disaster huh? Lets see... ")
            return log_message
